...
class XMainCache
{
    ...
    static GetApp(AppID: string, pContex: any, pCallBack: XAppLoad | any)
    {
        ...
        this._Client.SendAsync(Paths.AppModel, { ID: AppID }, (pData: XResponse<XAPPModel>, pCallData: any | null, pEvent: any | null) =>
        {
    ...
    static GetService(AppID: string, pContex: any, pCallBack: XAppLoad | any)
    {
        let app = this.AppCache[AppID];
        if (app)
        {
