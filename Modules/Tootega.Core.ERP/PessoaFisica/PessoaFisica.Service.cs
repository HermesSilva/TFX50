...
namespace Tootega.Core.ERP.PessoaFisica
{
    ...
    public class PessoaFisicaService : XService, IPessoaFisicaService
    {
        ...
        {
            var ctx = Context;
            var query =  from ERPxPessoaFisica in ctx.ERPxPessoaFisica
                        join CORxPessoa in ctx.CORxPessoa on ERPxPessoaFisica.ERPxPessoaFisicaID equals CORxPessoa.CORxPessoaID
                        join ERPxGenero in ctx.ERPxGenero on ERPxPessoaFisica.ERPxGeneroID equals ERPxGenero.ERPxGeneroID
                        select new { ERPxPessoaFisica, CORxPessoa, ERPxGenero };
;
            ...
            var qry = query.Select(q => new PessoaFisicaTuple(null,
                            ...
                            .Select(q => new PessoaFisicaTipoTuple(q.ERPxPessoaFisicaTipos.ERPxPessoaFisicaTiposID,
                                      q.ERPxPessoaFisicaTipos.ERPxPessoaFisicaID,
                                      q.ERPxPessoaFisicaTipos.ERPxPessoaFisicaTipoID,
                                      q.ERPxPessoaFisicaTipo.Tipo,
                                      q.ERPxPessoaFisicaTipos.CORxStatusID)).ToArray() : null));
            return qry;
        }
