...
using System.Text;
using Tootega.Core.ERP.ReadOnly.Rules;
...
namespace Tootega.Core.ERP.ReadOnly
{
    ...
    public class ProfissionalService : XService, IProfissionalService
    {
        ...
        {
            var ctx = Context;
            var query =  from ERPxProfissional in ctx.ERPxProfissional
                        join CORxPessoa in ctx.CORxPessoa on ERPxProfissional.ERPxProfissionalID equals CORxPessoa.CORxPessoaID
                        ...
                        select new { ERPxProfissional, CORxPessoa, ERPxDocumento, ERPxPessoaFisica, ERPxGenero };
;
