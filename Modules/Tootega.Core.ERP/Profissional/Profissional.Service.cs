...
using System.Text;
using Tootega.Core.ERP.Profissional.Rules;
    ...
    public class ProfissionalService : XService, IProfissionalService
    {
        ...
        public IQueryable<ProfissionalTuple> ExecuteQuery(ProfissionalFilter pFilter, Boolean pFull)
        {
            ...
            var query =  from ERPxPessoaFisica in ctx.ERPxPessoaFisica
                        ...
                        select new { ERPxPessoaFisica, CORxPessoa, ERPxGenero, ERPxProfissional };
;
            ...
            var Categorias = pFull ? from ERPxProfissionalCategoria in ctx.ERPxProfissionalCategoria
            ...
            var qry = query.Select(q => new ProfissionalTuple(null,
                                  ...
                                  q.ERPxGenero.Genero,
                                  pFull ? Categorias.Where(q1 => q1.ERPxProfissionalCategoria.ERPxProfissionalID == q.CORxPessoa.CORxPessoaID )
                            .Select(q => new CategoriaTuple(q.ERPxProfissionalCategoria.ERPxCategoriaID,
                               q.ERPxCategoria.Categoria,
                               q.ERPxProfissionalCategoria.ERPxProfissionalCategoriaID,
                               q.ERPxProfissionalCategoria.ERPxProfissionalID)).ToArray() : null,
                            ...
                            .Select(q => new HorariosTuple(q.ERPxProfissionalHorario.Inicio,
                              ...
                              q.ERPxProfissionalHorario.Fim)).ToArray() : null));
            return qry;
        }
        ...
        private void SetProfissionalValues(DBContext ctx, ProfissionalDataSet pDataSet)
        {
            ...
            foreach (ProfissionalTuple stpl in pDataSet.Tuples)
            {
                ...
                SetCategoriasValues(ctx, stpl.Categorias);
                ...
                void SetCategoriasValues(DBContext ctx, CategoriaTuple[] pTuples)
                {
                    if (pTuples == null)
                        return;
