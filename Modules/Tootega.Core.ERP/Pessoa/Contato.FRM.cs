...
namespace Tootega.Core.ERP.Pessoa
{
    public class FRMContato : XFRMModel
    {
        public FRMContato()
        {
            ...
            fld.TargetFieldID = new Guid[] { new Guid("0F32B4ED-4483-4622-8A36-7506DE5D0D02") };
            ...
            fld.TargetFilterFieldID = new Guid[] {  };
            fld.SourceFilterFieldID = new Guid[] {  };
            fld.TargetFieldID = new Guid[] { new Guid("767320FE-B2B6-4B67-8DFD-0DD3930CEA27"), new Guid("BC39FC05-2AEB-423F-B6EC-E4D68B34AD7D") };
            fld.SourceFieldID = new Guid[] { new Guid("EDECF396-5C6C-4542-9DAC-40B615C431B2"), new Guid("945DC2FB-58F5-4DDF-ACBA-6F1D2A20EC31") };
            fld.DataSourceID = new Guid("4E22A7DA-AD65-4076-85B0-71C22F6634A6");
            fld.AutoLoad = false;
            fld.FilterInative = true;
            fld.IsAnswer = false;
