...
using System.Text;
using Tootega.Core.ERP.Pessoa.Rules;
    ...
    public class BuscaPessoaService : XService, IBuscaPessoaService
    {
        ...
        public IQueryable<BuscaPessoaTuple> ExecuteQuery(BuscaPessoaFilter pFilter)
        {
            ...
            var query =  from ERPxDocumento in ctx.ERPxDocumento
                        join CORxPessoa in ctx.CORxPessoa on ERPxDocumento.CORxPessoaID equals CORxPessoa.CORxPessoaID
                        join ERPxDocumentoTipo in ctx.ERPxDocumentoTipo on ERPxDocumento.ERPxDocumentoTipoID equals ERPxDocumentoTipo.ERPxDocumentoTipoID into gj_ERPxDocumentoTipo
                        from ERPxDocumentoTipo in gj_ERPxDocumentoTipo.DefaultIfEmpty()
                        ...
                        join ERPxContatoTipo in ctx.ERPxContatoTipo on ERPxContato.ERPxContatoTipoID equals ERPxContatoTipo.ERPxContatoTipoID into gj_ERPxContatoTipo
                        from ERPxContatoTipo in gj_ERPxContatoTipo.DefaultIfEmpty()
                        join ERPxFinalidade in ctx.ERPxFinalidade on ERPxEndereco.ERPxFinalidadeID equals ERPxFinalidade.ERPxFinalidadeID into gj_ERPxFinalidade
                        from ERPxFinalidade in gj_ERPxFinalidade.DefaultIfEmpty()
                        select new { ERPxDocumento, CORxPessoa, ERPxDocumentoTipo, ERPxContato, ERPxEndereco, ERPxContatoTipo, ERPxFinalidade };
;
