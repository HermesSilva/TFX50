...
{
    public  partial class TootegaCoreERPContext : XDBContext
    {
        #region _EMLxCaixa
        ...
        protected TootegaCoreERPContext(DbContextOptions pOptions)
          : base(pOptions)
        {
        
        }

        public TootegaCoreERPContext(DbContextOptions<TootegaCoreERPContext> pOptions)
          : base(pOptions)
        {
