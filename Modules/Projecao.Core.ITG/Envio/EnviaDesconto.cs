...
{
    [XRegister(typeof(EnviaDesconto), sCID)]
    public class EnviaDesconto : XEnvios
    {
        public const String sCID = "463B6E19-3E2A-4075-8DD9-4284D9C58262";
        ...
        {
            Type tp = XTypeCache.GetTypes<XLegacyTable>().FirstOrDefault(t => t.Name == "FAT_PROMOCAO");
