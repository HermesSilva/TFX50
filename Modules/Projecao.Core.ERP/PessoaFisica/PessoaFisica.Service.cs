...
{
    [XGuid("DF0B1AD3-584F-47FB-8418-650111A9A6D9", typeof(IPessoaFisicaService))]
    public class PessoaFisicaService : XService, IPessoaFisicaService
    {
        ...
        public abstract class BaseINFPessoaFisicaServiceRule : XServiceINFRule<PessoaFisicaService, PessoaFisicaTuple>
        {
            public BaseINFPessoaFisicaServiceRule(PessoaFisicaService pService)
                : base(pService)
            {
            }
        ...
        public PessoaFisicaService(ILogger<XService> pLogger, DBContext pContext)
               :base(pLogger)
        {
            Rule = new PessoaFisicaRule(this);
            _INFRule = new INFPessoaFisicaServiceRule(this);
            Context = pContext;
            _INFRule.SetContext(Context);
        }

        internal XIServiceRule<PessoaFisicaTuple, PessoaFisicaTuple> Rule;
        private INFPessoaFisicaServiceRule _INFRule;
        ...
        public IQueryable<PessoaFisicaTuple> ExecuteQuery(PessoaFisicaFilter pFilter, Boolean pFull)
        {
            var ctx = Context;
            var query = from CORxPessoa in ctx.CORxPessoa
                        ...
                        select new {ERPxPessoaFisica, ERPxGenero, CORxPessoa};
            ...
            var PessoaFisicaTipo = pFull ? from ERPxPessoaFisicaTipos in ctx.ERPxPessoaFisicaTipos
                        ...
                        select new {ERPxPessoaFisicaTipo, ERPxPessoaFisicaTipos} : null; 

            var qry = query.Select(q => new PessoaFisicaTuple(null,
                                  ...
                                  q.ERPxPessoaFisica.CORxStatusID,
                                  q.ERPxGenero.Genero, Contato = 
                            ...
                            .Select(q => new EnderecoTuple(){Localidade = q.CEPxLocalidade.Nome,
                                ...
                                Finalidade = q.ERPxFinalidade.Finalidade}).ToArray() : null, PessoaFisicaTipo = 
                                  pFull ? PessoaFisicaTipo.Where(q4 => q4.ERPxPessoaFisicaTipos.ERPxPessoaFisicaID == q.CORxPessoa.CORxPessoaID )
                            .Select(q => new PessoaFisicaTipoTuple(){ERPxPessoaFisicaTiposID = q.ERPxPessoaFisicaTipos.ERPxPessoaFisicaTiposID,
                                        ERPxPessoaFisicaID = q.ERPxPessoaFisicaTipos.ERPxPessoaFisicaID,
                                        ERPxPessoaFisicaTipoID = q.ERPxPessoaFisicaTipos.ERPxPessoaFisicaTipoID,
                                        Tipo = q.ERPxPessoaFisicaTipo.Tipo,
                                        CORxStatusID = q.ERPxPessoaFisicaTipos.CORxStatusID}).ToArray() : null));
            return qry;
        }

        public PessoaFisicaDataSet Execute(PessoaFisicaFilter pFilter, Boolean pFull)
        {
        ...
        public object Flush(PessoaFisicaDataSet pDataSet)
        {
        ...
        private void SetPessoaFisicaValues(DBContext ctx, PessoaFisicaDataSet pDataSet)
        {
            ...
            foreach (PessoaFisicaTuple stpl in pDataSet.Tuples)
            {
                ...
                ERPxPessoaFisicatpl.CORxStatusID = stpl.CORxStatusID.Value;
                ...
                SetPessoaFisicaTipoValues(ctx, stpl.PessoaFisicaTipo);
                ...
                void SetPessoaFisicaTipoValues(DBContext ctx, PessoaFisicaTipoTuple[] pTuples)
                {
                    if (pTuples == null)
                        return;
                    foreach (PessoaFisicaTipoTuple stpl in pTuples)
                    {
                        var sb = new StringBuilder();
