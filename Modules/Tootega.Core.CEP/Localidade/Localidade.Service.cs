    ...
    public class LocalidadeService : XService, ILocalidadeService
    {
        ...
        public IQueryable<LocalidadeTuple> ExecuteQuery(LocalidadeFilter pFilter)
        {
            ...
            var query =  from CEPxUF in ctx.CEPxUF
                        ...
                        join CEPxLocalidade in ctx.CEPxLocalidade on CEPxUF.CEPxUFID equals CEPxLocalidade.CEPxUFID
                        ...
                        select new { CEPxUF, CEPxPais, CEPxLocalidade, CEPxLocalidadeTipo };
;
